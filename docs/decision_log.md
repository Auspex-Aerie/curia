...
- **date:** 2026-08-02 · **status:** accepted · **triggered_by:** handback pass-c optionals; `DEC-036`, `DEC-037`, `DEF-017`, `HYP-003` · **docs_updated:** `docs/decision_log.md`, `RAGRouter/Training/docs/PLAN.md` §7.6 · **related:** `DEC-011`, `HYP-003`, `DEF-017`
- **decision:**
